...
export class CookbookMenuItem extends React.Component {
    constructor(props) {
        super(props);
    }
...
export class CookbookDropdownMenuItem extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            elementsInfo: []
...
export class CookbookSearchBox extends React.Component {
    constructor(props) {
        super(props);
    }
